...
public class Constants {
    ...
    public static final String COMPANY_ASSIGNMENT_DELAY = "Company.AssignmentDelay";
    public static final String COMPANY_ASSIGNMENT_INTERVAL = "Company.AssignmentInterval";
